...
with open("all_hexagons_data.json", 'w') as json_file:
    json.dump({"type": "FeatureCollection", "features": []}, json_file)
    
# Definir el tamaño del paso (step) para recorrer los píxeles en el mapa.
step_size_x = 100  # Un salto de 500 píxeles en el eje X
step_size_y = 100  # Un salto de 500 píxeles en el eje Y
